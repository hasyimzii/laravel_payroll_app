                                            ...
                                            <div class="modal-dialog modal-dialog-centered" role="document">
                                                <div class="modal-content">
                                                    <div class="modal-body">
                                                        ...
                                                        <h2 class="text-center text-dark">Ubah Presensi</h2>
                                                        <form class="d-inline" 
                                                            action="{{ route('presence.update', $item->id) }}" 
                                                            method="post">
                                                            @csrf
                                                            ...
                                                            <div class="form-group px-5 mx-4 mb-4">
                                                                ...
                                                                <select class="form-select" id="sel1" name="status">
                                                                    <option value="present" {{ ($item->status == 'present') ? 'selected' : '' }}>Masuk</option>
                                                                    <option value="leave" {{ ($item->status == 'leave') ? 'selected' : '' }}>Cuti</option>
                                                                </select>
                                                            </div>
                                                            <div class="d-flex d-row justify-content-center mb-3">
                                                                <button type="button" class="btn btn-secondary" data-dismiss="modal">Batal</button>
                                                                <button type="submit" class="btn btn-warning text-white ml-3">Ubah presensi</button>
                                                            </div>
                                                        </form>
                                                    </div>
                                                </div>
